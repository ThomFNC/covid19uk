...
def AddOccultProposal(
    ...
    def x_star(m, t):
        ...
        return UniformInteger(low=1, high=bound + 1, dtype=dtype, float_dtype=events.dtype)
...
def DelOccultProposal(
    ...
    def x_star(m, t):
        ...
        with tf.name_scope("x_star"):
            ...
            return UniformInteger(low=1, high=bound + 1, dtype=dtype, float_dtype=events.dtype, name="x_star")
