...
def read_challen_tier_restriction(tier_restriction_csv, date_low, date_high, lads=[]):
    ...
    if len(lads) > 0:
        ...
        print('Downselecting to',len(lads),'LADs')
    ...
    # Drop the TESTLADs now their job is done
